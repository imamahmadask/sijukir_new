...
new class extends Component {
    ...
    public function save()
    {
        $this->validate([
            ...
            'nik_jukir'     => 'required|string|max:16|unique:jukirs,nik_jukir',
            ...
            'kab_kota_alamat' => 'required|string',
            'uji_petik'     => 'nullable|string',
            'tgl_pkh_upl'   => 'nullable|date',
            'potensi_bulanan' => 'required|numeric',
            'potensi_bulanan_upl' => 'nullable|numeric',
        ]);
        ...
        $data = [
            ...
            'uji_petik'         => $this->uji_petik ?: 0,
            'tgl_pkh_upl'       => $this->tgl_pkh_upl ?: null,
            'potensi_bulanan_upl' => $this->potensi_bulanan_upl ?: 0,
        ...
        $jukir = Jukir::create($data);

        $this->changeIsJukirLokasiBaru($jukir->lokasi);

        session()->flash('success', 'Jukir berhasil ditambahkan.');
        return redirect()->route('jukir.index');
    }

    public function changeIsJukirLokasiBaru($lokasi){
    ...
    {
        return $this->view()->title('Tambah Jukir');
    }
};
?>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label">Nama Jukir</label>
                    ...
                    <div class="card-footer text-end">
                        ...
                        <button type="submit" class="btn btn-primary" wire:loading.attr="disabled">
                            <span wire:loading.remove wire:target="save">Simpan Jukir</span>
